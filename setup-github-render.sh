...
if [ $? -eq 0 ]; then
    ...
    echo -e "   - VITE_OPENROUTER_API_KEY"
    echo -e ""
    echo -e "   For OpenRouter, use this key:"
    echo -e "   ${GREEN}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${NC}"
    echo -e ""
